    ...
    <div className="min-h-screen pb-24 animate-in fade-in duration-1000 bg-[#020202]">
      ...
      <div className="relative pt-20 pb-16 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10 space-y-8 text-center flex flex-col items-center">
          <Link href="/#projects" className="inline-flex items-center gap-2 text-white/50 hover:text-lcars-gold transition-colors font-mono tracking-widest uppercase text-xs">
            <ArrowLeft className="w-4 h-4" />
            Back to Hub
          </Link>

          <div className="space-y-6 max-w-3xl">
            <div className="inline-flex items-center justify-center gap-3 px-4 py-2 bg-white/5 border border-lcars-gold/20 rounded-full font-mono text-xs uppercase tracking-widest text-lcars-gold">
              <Microchip className="w-4 h-4" />
              Embedded Hardware
            </div>
            <h1 className="text-6xl md:text-8xl font-black uppercase tracking-tighter text-white">UniControl</h1>
      ...
      <div className="max-w-5xl mx-auto px-6 space-y-16 relative z-10">
        ...
        {/* ── SCHEMATIC VIEW ── */}
        <div className="glass p-2 border-white/10 rounded-[32px] overflow-hidden">
          <div className="bg-[#050505] rounded-[24px] p-8 md:p-12 relative overflow-hidden border border-white/5">
            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="space-y-4">
                ...
                <h3 className="text-lg font-black text-white uppercase tracking-tight">Core Processing</h3>
              ...
              <div className="space-y-4">
                ...
                <h3 className="text-lg font-black text-white uppercase tracking-tight">Radar Integration</h3>
                <p className="text-sm text-white/50 leading-relaxed">
              ...
              <div className="space-y-4">
                ...
                <h3 className="text-lg font-black text-white uppercase tracking-tight">HMI Display</h3>
                <p className="text-sm text-white/50 leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
          <div className="glass p-8 md:p-12 rounded-[32px] border-white/10 space-y-6">
            ...
            <div className="flex items-center gap-4 text-xs font-mono mt-4">
              <span className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-lg text-white/80 flex items-center gap-2">
          ...
          <div className="glass p-8 md:p-12 rounded-[32px] border-white/10 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 pt-2">
              {['ESP-IDF', 'C / C++', 'ESP32-S3', 'Nextion', 'CAN Bus', 'Brigade Radar'].map(tech => (
                <div key={tech} className="border border-white/5 bg-white/5 px-4 py-3 rounded-xl flex items-center gap-3 font-mono text-xs text-white/70">
