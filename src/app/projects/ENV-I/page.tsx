...
export default function ENVIPage() {
      ...
      <div className="relative pt-20 pb-16 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10 space-y-8">
          ...
          <div className="space-y-6">
            ...
            <h1 className="text-6xl md:text-8xl font-black uppercase tracking-tighter text-white">ENV-I</h1>
      ...
      <div className="max-w-5xl mx-auto px-6 space-y-16 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={i} className="glass p-6 rounded-2xl border-white/10 flex flex-col items-center text-center space-y-3 hover:border-white/20 transition-all">
              <m.icon className={`w-6 h-6 ${m.color}`} />
              <div>
                <div className="text-2xl font-black text-white tracking-tight">{m.val}</div>
                <div className="text-[10px] font-mono text-white/40 uppercase tracking-widest">{m.label}</div>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2 pt-4">
                {project?.metadata.techStack?.map(tech => (
                  <span key={tech} className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-lg text-xs font-mono text-white/70">
                    {tech}
                  </span>
                ))}
              </div>
          ...
          <div className="glass p-8 md:p-12 rounded-[32px] border-white/10 space-y-8 relative overflow-hidden group">
            ...
            <div className="space-y-4 relative z-10">
              ...
              <div className="pt-4 space-y-2">
                <div className="flex justify-between text-xs font-mono border-b border-white/5 py-2">
                  <span className="text-white/40">Auth Level</span>
                  <span className="text-lcars-orange font-bold">STRICT_ENFORCED</span>
                </div>
                <div className="flex justify-between text-xs font-mono border-b border-white/5 py-2">
                  <span className="text-white/40">Read/Write</span>
        ...
        <div className="space-y-8">
          <h2 className="text-3xl font-black text-white uppercase tracking-tight text-center">Genişletilmiş Özellikler</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="glass p-8 rounded-3xl border-white/10 space-y-4 hover:border-lcars-cyan/30 transition-all">
              <ScanLine className="w-8 h-8 text-lcars-cyan" />
              <h3 className="text-lg font-black text-white uppercase tracking-tight">Barkod & Lot Takibi</h3>
            ...
            <div className="glass p-8 rounded-3xl border-white/10 space-y-4 hover:border-lcars-orange/30 transition-all">
              <Globe className="w-8 h-8 text-lcars-orange" />
              <h3 className="text-lg font-black text-white uppercase tracking-tight">Full i18n Desteği</h3>
              <p className="text-white/50 text-sm leading-relaxed">
            ...
            <div className="glass p-8 rounded-3xl border-white/10 space-y-4 hover:border-lcars-purple/30 transition-all">
              <FileSpreadsheet className="w-8 h-8 text-lcars-purple" />
              <h3 className="text-lg font-black text-white uppercase tracking-tight">Raporlama</h3>
              <p className="text-white/50 text-sm leading-relaxed">
